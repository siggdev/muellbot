            ...
            <div class="card-body">
                <form action="/trash_type" method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="z.B. Restmüll" />
                    ...
                    <div class="row">
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="color" id="color" name="color" class="form-control form-control-color" value="{{ old('color') ?? '#000000' }}" />
                            <small class="text-danger">{{ $errors->first('color') }}</small>
                        </div>
                        <div class="col-sm-3 mb-3">
                            <label for="text_color">Text</label>
                            <input type="color" id="text_color" name="text_color" class="form-control form-control-color" value="{{ old('color') ?? '#ffffff' }}" />
                            <small class="text-danger">{{ $errors->first('text_color') }}</small>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <label for="preview">Vorschau</label>
                            <input type="text"id="preview" name="preview" style="background-color: #000000; color: #ffffff" class="form-control" value="" />
                        </div>
                    </div>
